...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const mailtoLink = `mailto:palani.dev@example.com?subject=Portfolio Contact: ${encodeURIComponent(formData.name)}&body=${encodeURIComponent(
      `Name: ${formData.name}
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="space-y-6">
              {[
                { icon: Mail, label: "Email", value: "palanikathirvel05@gmail.com" },
                { icon: Phone, label: "Phone", value: "+919342785176" },
                { icon: MapPin, label: "Location", value: "Kovilpatti,Thoothukudi" },
              ].map((item, index) => {
